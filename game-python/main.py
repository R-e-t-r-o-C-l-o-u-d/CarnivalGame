        ...
        if data != "-1":
            if data == "miss":
                ...
                asyncio.get_event_loop().run_until_complete(
                    client.sendState(level * 100, 0))  # Send status code 0 to update database and show scoreboard.
            if data == "hit":
                global level
                ...
                asyncio.get_event_loop().run_until_complete(
                    client.sendState(level * 100, 1))  # Send status code 1 to continue game
